...
- Mount the PVC at the DB path; set `ODONIAN_DB` to a file on it.
- `ODONIAN_TOKEN` from a `Secret`.
...
**PR**: https://github.com/boldfield/odonian/pull/17
**Branch**: odonian/T15-k8s-manifests
