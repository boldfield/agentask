...
func TestMigrations(t *testing.T) {
	...
	if migrationCount != 11 {
		t.Errorf("expected 11 migrations to be recorded, but got %d", migrationCount)
	}
	...
	if migrationCount != 11 {
		t.Errorf("expected 11 migrations after re-open (idempotency), but got %d", migrationCount)
	}
}
...
func TestOpenSamePath(t *testing.T) {
	...
	if migrationCount != 11 {
		t.Errorf("expected 11 migrations after second open, but got %d", migrationCount)
	}
}
